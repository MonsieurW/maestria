	...
	<table class="table">
		...
		<?php if(isset($classe)){
			foreach ($classe as $key => $value) {
				echo '<tr><td>
				<a class="editable editable-click" data-type="text" data-pk="'.$value['idTheme'].'">'.$value['themeValue'].'</a>
				<span class="pull-right">
					<a href="#" class="trash btn btn-mini btn-danger" data-id="'.$value['idTheme'].'">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">New Theme</h4>
      </div>
