	...
	<table class="table">
		...
		<?php if(isset($classe)){
			foreach ($classe as $key => $value) {
				echo '<tr><td>
				<a class="editable editable-click" data-type="text" data-pk="'.$value['idDomain'].'">'.$value['domainValue'].'</a>
				<span class="pull-right">
					<a href="#" class="trash btn btn-mini btn-danger" data-id="'.$value['idDomain'].'">
